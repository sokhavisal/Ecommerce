...
-- --------------------------------------------------------
INSERT INTO `tbl_Catagory` (`CatNoAuto`, `CatNo`, `CatDescription`, `CatDescriptionHtml`, `CatName`, `CatNameHtml`, `CatImagePath`, `CatImagePathHtml`) VALUES
(1, 'SS', 'Made in japan', '', 'Samsung', '', '', '');
--
...
-- --------------------------------------------------------
INSERT INTO `tbl_Items` (`ItemNoAuto`, `ItemNo`, `ItemName`, `ItemDescription`, `ItemDetail`, `ItemImagePath`, `CatNoAuto`, `CatName`, `BarcodeNo1`, `BarcodeNo2`, `BarcodeNo3`, `BarcodeNo4`, `ItemUnitAuto`, `ItemUnitName`, `ItemPrice`, `ItemCost`, `ItemOrder`, `ItemOnhand`, `ItemCostType`, `ItemNameHtml`, `ItemDescriptionHtml`, `ItemDetailHtml`, `ItemImagePathHtml`, `ItemPriceHtml`, `ItemIsStock`, `ItemIsNew`, `ItemIsDisplayWeb`) VALUES
(1, 'A', 'ItemA', 'ItemA', 'ItemA', 'ItemA', 1, 'ItemA', 'ItemA', 'ItemA', 'ItemA', 'ItemA', 1, 'ItemA', '100', '100', '100', '100', '1', 'ItemA', 'ItemA', 'ItemA', 'ItemA', 'ItemA', 1, 1, 1);
--
